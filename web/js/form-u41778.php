...
function emailFormSubmission()
{
	...
	$subject = 'Envío de Formulario Eventos';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre: *:</b></td><td>' . htmlentities($_REQUEST["custom_U41793"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Empresa:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U41788"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U41820"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>País:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U41815"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cargo:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U41809"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Apellido:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U41798"],ENT_COMPAT,'UTF-8') . '</td></tr>';
