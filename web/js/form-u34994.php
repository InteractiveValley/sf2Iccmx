...
{
	$to = 'acorona@websider.com.mx';
	$subject = 'Envío de Formulario Newsletter';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre: *:</b></td><td>' . htmlentities($_REQUEST["custom_U35031"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Empresa:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U35036"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U35054"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>País:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U34996"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cargo:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U35042"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Apellido:&nbsp; *:</b></td><td>' . htmlentities($_REQUEST["custom_U35026"],ENT_COMPAT,'UTF-8') . '</td></tr>';
